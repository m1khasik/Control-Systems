<template>
  <div class="login-container">
    ...
    <!-- Пасхалка: анимированная картинка -->
    <div v-if="showEasterEgg" class="easter-egg-container">
      <img 
        src="https://i.pinimg.com/1200x/8f/95/a8/8f95a85c758d41f8b5132a1e7b0e032f.jpg" 
        alt="TAHO"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const handleSubmit = () => {
      // Если введён пароль TAHO — не пытаемся авторизоваться
      if (password.value === 'TAHO') {
        return
      }
